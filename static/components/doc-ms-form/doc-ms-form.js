define('components/doc-ms-form/doc-ms-form.ts', function(require, exports, module) {
  ...
  avalon.component(exports.name, {
      ...
      defaults: {
          ...
          json: '',
          expire: 0,
          fileUploadUrl: configService_1.serviceUrl + '/api/file/uploadFile',
