...
.ane-select-dropdown {
  ...
  .ane-select-dropdown-menu {
    ...
    .ane-select-dropdown-menu-item {
      ...
      overflow: hidden;
      user-select: none; }
      .ane-select-dropdown-menu-item:focus, .ane-select-dropdown-menu-item:hover {
        background: #c7ddef; }
        .ane-select-dropdown-menu-item:focus i, .ane-select-dropdown-menu-item:hover i {
          color: #dddddd;
          display: inline-block; }
    ...
    .ane-select-dropdown-menu-item-selected {
      ...
      .ane-select-dropdown-menu-item-selected i {
        color: #337ab7;
        display: inline-block; }
    .ane-select-dropdown-menu-item-disabled, .ane-select-dropdown-menu-item-disabled:hover {
...
.ane-calendar-prev-month-cell .ane-calendar-date, .ane-calendar-next-month-cell .ane-calendar-date {
  color: #b3b3b3; }
...
.ane-checkbox {
  ...
  .ane-checkbox input[type=checkbox] {
    ...
    height: 18px;
    cursor: pointer; }
  .ane-checkbox input[type=checkbox]:checked, .ane-checkbox input[type=checkbox]:focus {
    outline: 0 !important; }
...
.ane-radio {
  ...
  .ane-radio input[type=radio] {
    ...
    height: 18px;
    cursor: pointer; }
  .ane-radio input[type=radio]:checked, .ane-radio input[type=radio]:focus {
    outline: 0 !important; }
